...
App supports two languages: English and Portuguese (Brazil). You can add more languages by adding the translation files in the `src/translations` folder and adding the language code to the `src/lib/i18n/resources.ts` file.
