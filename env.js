...
const BUNDLE_ID = 'br.com.meusdesafios'; // ios bundle id
const PACKAGE = 'br.com.meusdesafios'; // android package name
const NAME = 'Meus Desafios'; // app name
const EXPO_ACCOUNT_OWNER = 'psneves'; // expo account owner
const EAS_PROJECT_ID = 'eb6614d8-0d20-44d6-a430-9fd7bfced3be'; // eas project id
const SCHEME = 'meusDesafiosApp'; // app scheme
